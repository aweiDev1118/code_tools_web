...
`}),x=P(()=>{if(!b.value)return"";const{className:i}=b.value,l=b.value.fields.find(p=>p.isPrimaryKey),r=(l==null?void 0:l.javaType)||"Long";return`package ${L.value};
...
`),j=r.map(o=>`            <if test="${o.javaName} != null">${o.column},</if>`).join(`
...
<mapper namespace="${L.value}.${i}Mapper">
